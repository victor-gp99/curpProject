...
$(document).ready(function(){
    let consultaButton = $("#boton_curp");
  
    consultaButton.on("click",function(){
      calcularCurp();
    })
  });
...
function calcularCurp(){
  //Vinculando el DOM con JS Query
    var nombre=$("#nombre").val();
    var apellido_paterno=$("#apellido_paterno").val();
    var apellido_materno=$("#apellido_materno").val();
    var sexo=$('input[name="RadioDefault"]:checked').val();
    var estado=$("#estado").val();
    var temp = $("#fecha_nacimiento").val();
    var fecha_nacimiento = temp.split('-').reverse();
    
    //Checando campos llenos
     if (nombre=="" || apellido_materno=="" || apellido_paterno=="" || sexo=="" || estado=="" || fecha_nacimiento=="" ){
          alert("Falta información en algun input...¡CHECA TUS CAMPOS!");
      }else{  
      var curp = generaCurp({
        nombre            : nombre,
      ...
      $("#res").val(curp);//Guardando el resultado en un input
    }
